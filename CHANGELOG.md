...
- The Accessibility check runs on the reader-engine previews too, auditing the paginated chapter and re-checking as you edit.
- The Announce preview is available on the Responsive view (and the raw file:// previews); on reader-engine views it steps aside for now rather than reporting on the wrong document.
