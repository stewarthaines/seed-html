...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
	<rootfiles>
		<rootfile full-path="OEBPS/content.opf" media-type="application/oebps-package+xml"/>
			...
			const result = (packager as any).parseRootfilePath(containerContent);
			expect(result).toBe('OEBPS/content.opf');
		});

		it('should throw error for invalid container.xml', () => {
			const invalidContent = '<container></container>';
			
			expect(() => {
				(packager as any).parseRootfilePath(invalidContent);
			}).toThrow('Could not find rootfile path in container.xml');
		});
	});
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
	<metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
		...
		<dc:date>2024-01-01</dc:date>
			...
			const result = (packager as any).parseOPFMetadata(opfContent);
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
	<metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
		...
		<dc:identifier id="uid">test-book-123</dc:identifier>
			...
			expect(() => {
				(packager as any).parseOPFMetadata(opfContent);
			}).toThrow('Missing required dc:title in OPF metadata');
		});

		it('should throw error for missing required language', () => {
			const opfContent = `<?xml version="1.0" encoding="UTF-8"?>
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
	<metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
		<dc:title>Test Book</dc:title>
		<dc:identifier id="uid">test-book-123</dc:identifier>
			...
			expect(() => {
				(packager as any).parseOPFMetadata(opfContent);
			}).toThrow('Missing required dc:language in OPF metadata');
		});

		it('should throw error for missing required identifier', () => {
			const opfContent = `<?xml version="1.0" encoding="UTF-8"?>
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
	<metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
		<dc:title>Test Book</dc:title>
		<dc:language>en</dc:language>
			...
			expect(() => {
				(packager as any).parseOPFMetadata(opfContent);
			}).toThrow('Missing required dc:identifier in OPF metadata');
		});
	});
