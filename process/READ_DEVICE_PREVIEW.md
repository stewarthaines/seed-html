...
**Remaining before calling the feature done (phase 3)**: ~~the Safari 16 eyeball~~ **confirmed working on Safari 16 / iOS against production, 2026-07-24** — the last phase 1 checkpoint closes; the side-by-side feel comparison against Publish → Read stays parked (chapter-only stands). Follow-on: `process/FOLIATE_UNIFIED_PREVIEW.md` extends this engine to the device presets.
